...
library(ggplot2)
library(readxl)
Zarea_EMGon <- read_excel("Datafile.xlsx",sheet = "ADVsize_Timecourse_EMGonset")
Zarea_Movon <- read_excel("Datafile.xlsx",sheet = "ADVsize_Timecourse_MoveOnset")
Zarea_EMGoff <- read_excel("Datafile.xlsx",sheet = "ADVsize_Timecourse_EMGoffset")
Zarea_Reton <- read_excel("Datafile.xlsx",sheet = "ADVsize_Timecourse_ReturnOn")
...
p1 = ggplot(All1,aes(x=time, y=value, color=dir))+
  geom_point(size=3)+
  geom_line(size=1)+ggtitle("EMG onset")+
...
p2 = ggplot(All2,aes(x=time, y=value, color=dir))+
  geom_point(size=3)+
  geom_line(size=1)+ggtitle("Movement onset")+
  geom_errorbar(aes(ymin=cint_m,ymax=cint_p))+
  scale_color_manual(values=c(4,2))+
  theme(axis.title.x = element_blank())
...
p3 = ggplot(All3,aes(x=time, y=value, color=dir))+
  geom_point(size=3)+
  geom_line(size=1)+ggtitle("EMG offset")+
  geom_errorbar(aes(ymin=cint_m,ymax=cint_p))+
  scale_color_manual(values=c(4,2))+
  theme(axis.title.x = element_blank())
...
p4 = ggplot(All4,aes(x=time, y=value, color=dir))+
  geom_point(size=3)+
  geom_line(size=1)+ggtitle("Return onset")+
  geom_errorbar(aes(ymin=cint_m,ymax=cint_p))+
  scale_color_manual(values=c(4,2))+
  theme(axis.title.x = element_blank())
